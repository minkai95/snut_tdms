...
<div class="wrapper">
    <header class="header">
        ...
        <div class="headerRight">
            <div class="welcome">你好，<a href="${ctx}/user/personCenter" target="mainFrame" id="username">${userInfo.name}</a></div>
        </div>
    </header>
    <div class="middle">
        <div class="leftContent">
            <ul class="aside">
                ...
                <li id="publicData"><a href="${ctx}/studentOffice/studentOfficePublicData" target="mainFrame"><i class="icon-folder-open"></i>公共资料</a></li>
                <li id="personData"><a href="${ctx}/studentOffice/studentOfficePersonData" target="mainFrame"><i class="icon-briefcase"></i>私有资料</a></li>
                ...
                <li><a href="${ctx}/studentOffice/dataTrace" target="mainFrame"><i class="icon-screenshot"></i>资料追踪</a></li>
                <li id="teacherNews"><a href="${ctx}/studentOffice/studentOfficeNews" target="mainFrame"><i class="icon-bell-alt"></i>消息通告</a></li>
            </ul>
        </div>
        <div class="rightContent">
            <iframe id="mainFrame" class="mainFrame" name="mainFrame" src="${ctx}/studentOffice/studentOfficeCurrent"></iframe>
        </div>
    </div>
</div>
