...
<body>
    <div class="adminCurrentWrapper">
        <div class="teacherHeader">
            ...
            <div class="teacherUpload">
                ...
                <button id="openModal" class="btn btn-success upload batchDelete"><i class="icon-plus-sign" style="margin-right: 5px;"></i>新增类目</button>
            </div>
        </div>
    ...
    <script>
        ...
        $('#addClassTypeSubmit').click(function () {
            ...
            $.ajax({
                url:"${ctx}/admin/addDataClass?name="+name+"&roleId=004"+"&property1Id="+property1Id+"&property2Id="+property2Id+"&property3Id="+property3Id,
                type:"POST",
                dataType:"json",
