    ...
    <div class="wrapper">
        <header class="header">
            ...
            <div class="headerRight">
                <div class="welcome">欢迎您：<a href="${ctx}/user/personCenter" target="mainFrame" id="username">${userInfo.name}</a> <a href="${ctx}/user/logout" class="loginOut"><i class="icon-signout"></i>注销</a></div>
            </div>
        </header>
        <div class="middle">
