                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${adminUserInfoList}" var="userInfo" varStatus="userInfoStatus">
                            <tr id="${userInfo.user.username}">
                                <td style="text-align: center; width: 5%;"><input class="checkBtn checkedBtn" type="checkbox">${userInfoStatus.index+1+(page.currentPage-1)*10}</td>
    ...
    <script>
        ...
        $("#batchDelete").click(function(){
            ...
            if (checkedTrId.length>0){
                $.confirm({
                    title: '提示',
                    content: '确认删除'+checkedTrId.length+'位管理员？<input style="margin-top:5px;" class="form-control" type="text" id="deleteReason" placeholder="请输入删除原因(选填)"/>',
                    buttons: {
                        取消: function() {
                        },
                        确定: function(){
