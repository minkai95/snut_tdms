...
<head>
    <title>申请类目</title>
    <style>
        .n-error{top: 5px !important;left: -115px !important;  }
    </style>
</head>
<body>
        ...
        <c:forEach items="${haveDataClassList}" var="dataClassHelp">
            <div class="typeWrapper">
                ...
                <div class="propertyNameCont">
                    <ul>
                        <c:choose>
                            <c:when test="${dataClassHelp.classTypeHelpClassList.size()>0 && dataClassHelp.classTypeHelpClassList.get(0).classType!=null}">
